...
5. [.NET CLI 基本コマンド](#5-net-cli-基本コマンド)
   - [基本コマンド一覧](#基本コマンド一覧)
   - [パッケージ管理コマンド](#パッケージ管理コマンド)
   - [ビルドと実行の流れ](#ビルドと実行の流れ)
6. [初回プロジェクト作成](#6-初回プロジェクト作成)
   - [テンプレート 比較一覧](#テンプレート-比較一覧)
   - [Web API プロジェクト](#61-web-api-プロジェクト最もよく使う)
   - [MVC プロジェクト](#62-mvc-プロジェクト)
   - [プロジェクトのライフサイクル](#63-プロジェクトのライフサイクル)
   - [開発用 HTTPS 証明書の設定](#64-開発用-https-証明書の設定)
7. [まとめ](#7-まとめ)
