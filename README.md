...
| 第 8 章 | [データベースアクセスと ORM（Entity Framework Core）](src/content/docs/08-entity-framework-core/index.md) | <ol><li>概要と設計方針</li><li>DbContext と ASP.NET Core への組み込み</li><li>クエリの基本</li><li>保存とトランザクションの基本</li><li>マイグレーションとスキーマ管理</li><li>テストとアーキテクチャ</li><li>参考ドキュメント</li></ol> |
| 第 9 章 | [認証と認可](src/content/docs/09-authentication-and-authorization/index.mdx) | <ol><li>認証と認可とは</li><li>ASP.NET Core Identity 入門</li><li>外部ログインと OAuth / OpenID Connect</li><li>JWT Bearer 認証の導入</li><li>ポリシーベース認可とロールベース認可</li><li>認証・認可ミドルウェアの設定</li><li>参考ドキュメント</li></ol> |
